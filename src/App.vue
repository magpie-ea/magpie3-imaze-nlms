<template>
  <Experiment title="magpie3-imaze-nlms">
    <InstructionScreen :title="'Welcome'">
      Thank you for taking part in this experiment. Your participation is
      voluntary. You may quit any time.
      <br />
    ...
    <InstructionScreen :title="'General Instructions'">
      Your task is to read sentences word-by-word. The catch is that you will
      always see two candidate words on the screen. Only one of the two words is
      the one you should choose. The other word is a lure. The lure may be
      non-word, just nonsense like "oquitr". The lure may also be real English
      word, but an ungrammatical continuation of the sentence. In rare cases,
      both the correct word and the lure word could be grammatical continuations
      of the sentence, in which case you should guess the more likely
      continuation based on the sentences meaning.
      <br />
      <br />
      In sum: Your task is to always choose the correct word on the screen as
      fast and accurately as possible.
      <br />
      <br />
      The experiment will take approximately 20 minutes. You can take breaks any
      time. Please work with full focus and concentration.
      <br />
      <br />
      We will start with a few practice trials.
      <br />
      <br />
      Press F to select the left word, and J to select the right word on the
      screen.
    </InstructionScreen>
...
var nextWord = function (response, j) {
  ...
  var decodedResponse =
    response == 'right' ? this.getRightOption(j) : this.getLeftOption(j);
